app.controller("ArticleEditController", function ($scope, $http) {
    ...
    $http({
        method: "GET",
        headers: GetHeader(),
        url: "https://localhost:7019/api/Category/GetAllNonDeleted"
    ...
    $http({
        method: "GET",
        headers: GetHeader(),
        url: "https://localhost:7019/api/Article/GetById?id=" + $scope.GetUrlParameter("Id")
    }).then(function (response) {
    ...
    $scope.ArticleEdit = function () {
        $http({
            method: "PUT",
            headers: GetHeader(),
            url: "https://localhost:7019/api/Article/Update?articleId=" + $scope.GetUrlParameter("Id"),
            data: $scope.article
        }).then(function (response) {
